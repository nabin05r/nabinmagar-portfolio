      ...
      <div className="py-8 text-sm flex flex-col md:flex-row md:justify-between items-start md:items-center gap-8">
        <div className="order-2 md:order-1 w-full">
          ...
          <div className="flex gap-15 justify-between md:justify-start">
            <div>
              <p className="text-white/60 mb-4 uppercase text-[10px] tracking-widest">Location</p>
              <p>Kathmandu, Nepal</p>
            </div>
            <div className="">
            <p className="text-white/60 mb-4 uppercase text-[10px] tracking-widest">Local Time</p>
              <p>{time} UTC+5:45</p> {/* ← live time */}
            </div>
          </div>
        </div>
        <div className="order-1 md:order-2">
          <p className="text-white/60 mb-4 uppercase text-[10px] tracking-widest">Socials</p>
